...
const contractPath_default = './contracts/CxpCoin.sol';
...
function compileContract(contractPath, contractFile) {
    ...
    const abi = compiledObject.contracts["CxpCoin.sol"]["CxpCoin"].abi;
...
function substituteDependencyLine(line) {
    if (line.indexOf('PauserRole.sol') >= 0)
        return ('import "../../../CxpCoin/contracts/PauserRole.sol"');
    else
        return line;
}
